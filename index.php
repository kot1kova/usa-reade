...
<main class="main-page">
    <section
        class="hero"
        style="background-image: url(<?php bloginfo('template_url'); ?>/assets/img/bg_image.png)">
        <div class="hero__inner container">
            <div class="hero__banner">
                <h1 class="hero__title">
                    <?php the_field('main_page_title', 18) ?>
                </h1>
                <p class="hero__subtitle">
                    <?php the_field('main_page_subtitle', 18) ?>
                </p>
                <a href="#" class="btn btn-contacts">Contact us</a>
            </div>
        </div>
    </section>
    <section class="stats">
    ...
    <section class="about">
        <div class="about__inner container">
            <div class="about__card">
                ...
                <p class="about__text">
                    <?php the_field('about_us_text', 18) ?>
                </p>
                <a href="#" class="btn btn-card">More on Our History</a>
            </div>
            <!-- about__card -->
            <!-- <div class="abous__img"></div> -->
            <img src="<?php the_field('women_about', 18) ?>" alt="" class="about__img" />
        </div>
    </section>
    <section class="services">
        <div class="services__inner container">
            ...
            <div class="services__cards-row">
                ...
                <?php if (have_rows('services', 18)) :
                    while (have_rows('services', 18)) :
                        the_row(); ?>

                        <div
                            class="services__card"
                            style="background-image: url(<?php the_sub_field('services_photo'); ?>">
                            <p class="services__text"><?php the_sub_field('services_title');
                                                        18 ?></p>
                        </div>
                <?php endwhile;
                endif; ?>
            ...
            <a class="btn btn-services">Contact Us</a>
    </section>
        ...
        <div class="reviews__inner">
            ...
            <div class="swiper reviews-slider">
                <div class="swiper-wrapper">
                    <?php if (have_rows('reviews', 18)) :
                        while (have_rows('reviews', 18)) :
                            the_row(); ?>
